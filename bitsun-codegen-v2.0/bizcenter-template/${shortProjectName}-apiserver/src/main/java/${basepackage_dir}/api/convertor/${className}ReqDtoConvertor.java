...
package ${basepackage}.api.convertor;
...
import com.bitsun.core.common.convertor.IDtoConvertor;
/**
 * ${remark!}
...
public abstract class ${className}ReqDtoConvertor implements IDtoConvertor<${className}ReqDto,${className}Entity,${className}Po> {
