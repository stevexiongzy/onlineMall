...
import com.bitsun.core.common.convertor.IEntityConvertor;
...
abstract class ${className}EntityConvertor implements IEntityConvertor<${className}Entity,${className}Po> {
