...
public class ${className}Po extends BasePo<${className}Po> implements Serializable{
    ...
    @TableField(el = "${column.columnNameLower}, typeHandler=com.bitsun.core.common.mybatis.handler.JsonbTypeHandler")
    private String ${column.columnNameLower};
        <#elseif column.sqlTypeName?lower_case == 'json' >
    @TableField(el = "${column.columnNameLower}, typeHandler=com.bitsun.core.common.mybatis.handler.JsonTypeHandler")
    private String ${column.columnNameLower};
