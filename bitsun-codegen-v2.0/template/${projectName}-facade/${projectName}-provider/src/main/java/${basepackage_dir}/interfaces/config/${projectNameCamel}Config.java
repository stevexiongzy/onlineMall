package ${basepackage}.interfaces.config;
 ...
 */
@Import({LoggerLevelRefresher.class,YamlConfigService.class, JsonConfigService.class,
    JWTRealm.class,RedisConfig.class, AppExceptionHandler.class,MybatisPlusConfiguration.class,
    ApolloConfigController.class,FeignClientController.class})
@Configuration
    ...
    class SwaggerDocumentationConfig {
        ...
        public Docket customImplementation() {
            return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("${basepackage}.interfaces")).build()
                .apiInfo(apiInfo());
        }
    }
